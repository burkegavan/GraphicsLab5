...
GLfloat movePerson = -5.0f;
GLfloat moveCamera = 0.0f;
...
void display(){
	...
	view = look_at(vec3(strafe, 0.0f, movePerson), vec3(strafe, 0.0f, moveCamera), vec3(0.0f, 1.0f, 0.0f));
	...
	//view = translate (view, vec3 (0.0, 0.0f, -5.0f));
